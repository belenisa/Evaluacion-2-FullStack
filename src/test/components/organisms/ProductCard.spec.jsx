...
describe('ProductCard Component', () => {
  ...
  it('renderiza el título del producto', () => {
    ...
    expect(screen.getByText((text) => text.includes(mockProduct.name))).toBeTruthy();
  });
  ...
  it('renderiza la descripción del producto', () => {
    ...
    expect(screen.getByText((text) => text.includes(mockProduct.description))).toBeTruthy();
  });
  ...
  it('navega a detalles al hacer click en el botón', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/ProyectoDetalles/1', jasmine.any(Object));
  });
});